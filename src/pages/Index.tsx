    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="min-h-screen flex flex-col items-center px-4 sm:px-6 md:px-8 pt-8 sm:pt-12 md:pt-16">
        <div className="text-center mb-6 sm:mb-8 space-y-2 w-full">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-900 flex items-center justify-center gap-1">
        ...
        <div className="w-full max-w-[90%] sm:max-w-md md:max-w-lg p-3 sm:p-4 md:p-6">
            ...
            <Card className="w-full relative backdrop-blur-sm bg-white/90">
              ...
              <CardFooter className="flex flex-col space-y-3">
                ...
                <Button 
                  ...
                  disabled={isLoading}
                >
                  <UserPlus className="mr-1 h-3 w-3 sm:h-4 sm:w-4" /> Criar uma conta
                </Button>
              </CardFooter>
            </Card>
          </div>
